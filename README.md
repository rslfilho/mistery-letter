...
O objetivo deste projeto era desenvolver uma aplicação que gerasse uma carta estilo misteriosa a partir do texto introduzido pelo usuário. Nele eu utilizei `HTML`, `CSS` e `JavaScript`.
...
![printscreen](./mistery-letter.png)
